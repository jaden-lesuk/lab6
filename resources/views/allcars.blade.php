...
<nav class="navbar navbar-expand-sm bg-dark navbar-dark">
   ...
   <thead>
   <tr>
   <th scope="col" class="text-primary">Car ID</th>
       <th scope="col" class="text-primary">Make</th>
       <th scope="col" class="text-primary">Model</th>
       <th scope="col" class="text-primary">Produced on</th>
       <th scope="col" class="text-primary">Make review</th>
   </tr>
   </thead>
